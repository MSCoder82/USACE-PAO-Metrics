...
drop trigger if exists set_team_id_on_social_media_entries on public.social_media_entries;
...
drop trigger if exists set_team_id_on_social_media_connections on public.social_media_connections;
...
drop policy if exists "Team members can view social media entries" on public.social_media_entries;
...
drop policy if exists "Team members can insert social media entries" on public.social_media_entries;
...
drop policy if exists "Team members can delete social media entries" on public.social_media_entries;
...
drop policy if exists "Team members can update their social media entries" on public.social_media_entries;
...
drop policy if exists "Team members can view feed connections" on public.social_media_connections;
...
drop policy if exists "Chiefs manage feed connections" on public.social_media_connections;
...
drop trigger if exists touch_social_media_connections on public.social_media_connections;
